...
<p><strong>International Journal of Artificial Intelligence and Quantum Technologies (IJAIQT)</strong>, published under the aegis of <strong>KIET (Deemed to be University)</strong>, Ghaziabad, accepts original research articles, review papers, technical notes, and short communications. Authors must strictly adhere to the following guidelines before submitting their manuscripts.</p>
...
<ul>
  ...
  <li><strong>Main Manuscript (Anonymized for Review):</strong>
    <ul>
      <li><strong>Title:</strong> Identical to the title page, without author details.</li>
      <li><strong>Abstract:</strong> A self-contained, structured abstract of 150–250 words outlining the objective, methodology, key findings, and conclusion.</li>
      <li><strong>Keywords:</strong> 4 to 6 relevant keywords listed alphabetically, separated by semicolons.</li>
      <li><strong>Main Body:</strong>
        <ol>
          <li><em>Introduction:</em> Context, research gap, literature background, and objective.</li>
          <li><em>Methodology / Theoretical Framework:</em> Detailed technical formulation, algorithms, architecture, or mathematical proofs.</li>
          <li><em>Results & Discussion:</em> Experimental validation, empirical data, tables, figures, and comparison with baseline models.</li>
          <li><em>Conclusion & Future Work:</em> Summary of key outcomes and potential future research directions.</li>
        </ol>
      </li>
      <li><strong>Acknowledgments:</strong> Acknowledge funding agencies, institutional support from KIET (Deemed to be University) or partner bodies, and technical assistance (included only in the final post-acceptance version).</li>
      <li><strong>Conflict of Interest:</strong> Explicit statement disclosing any potential financial or personal competing interests.</li>
      <li><strong>References:</strong> Fully cited sources following IEEE referencing style.</li>
    </ul>
  </li>
</ul>
...
const scopeTitle = 'Key Features & Quality Commitment';
...
<h2>Call for Papers — Upcoming Issue</h2>
<p><strong>International Journal of Artificial Intelligence and Quantum Technologies (IJAIQT)</strong>, an official academic initiative run by <strong>KIET (Deemed to be University)</strong>, Delhi NCR, Ghaziabad, Uttar Pradesh, invites original research articles, review papers, short communications, and case studies for its upcoming issue.</p>
...
<h3>Submission Timeline & Process</h3>
<table border="1" cellpadding="8" cellspacing="0" style="width: 100%; border-collapse: collapse;">
  ...
  <tbody>
    <tr>
      ...
      <td>25th of Every Month</td>
    </tr>
    <tr>
      <td>Notification of Acceptance</td>
      <td>Last Day of Every Month</td>
    </tr>
    <tr>
      <td>Final Camera-Ready Submission</td>
      <td>3rd of Upcoming Month</td>
    </tr>
    <tr>
      <td>Online Publication</td>
      <td>First Week of Upcoming Month</td>
    </tr>
  </tbody>
</table>
...
<h3>Track 1: Artificial Intelligence & Machine Learning Foundations</h3>
<ul>
...
<h3>Track 2: Quantum Computing & Information Science</h3>
<ul>
...
<h3>Track 3: Synergistic Quantum AI & Quantum Machine Learning (QML)</h3>
<ul>
...
<h3>Track 4: Computational Medicine, Genomics, and Healthcare (Multidisciplinary)</h3>
<ul>
...
<h3>Track 5: Smart Infrastructure, Energy, and Sustainable Engineering (Multidisciplinary)</h3>
<ul>
...
<h3>Track 6: Materials Science, Chemistry, and Physics Simulations (Multidisciplinary)</h3>
<ul>
...
<h3>Track 7: Finance, Fintech, and Socio-Economic Systems (Multidisciplinary)</h3>
<ul>
...
<h3>Track 8: Governance, Ethics, Policy, and Human-Technology Interaction (Multidisciplinary)</h3>
<ul>
...
const footerText = '© Copyright 2024 International Journal of Artificial Intelligence and Quantum Technologies (IJAIQT) - All rights reserved.';
...
async function updateData() {
  try {
    ...
    settings.scopeTitle = scopeTitle;
    settings.scopeText = scopeText;
