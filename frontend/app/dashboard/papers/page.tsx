                ...
                <div className="flex justify-between items-start gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-xs font-medium">
                      ...
                      <a href={`http://localhost:5001${paper.pdfUrl}`} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-red-600 hover:text-red-700 hover:underline">
