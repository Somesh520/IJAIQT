              ...
              {currentBannerUrl && (
                <div className="mb-4">
                  <div className="border border-slate-200 rounded-lg p-2 bg-slate-50">
                    <img 
                      src={currentBannerUrl.startsWith('http') ? currentBannerUrl : `http://localhost:5001${currentBannerUrl}`} 
                      alt="Top Banner" 
              ...
              {currentSideBannerUrl && (
                <div className="mb-4">
                  <div className="border border-slate-200 rounded-lg p-2 bg-slate-50 w-32">
                    <img 
                      src={currentSideBannerUrl.startsWith('http') ? currentSideBannerUrl : `http://localhost:5001${currentSideBannerUrl}`} 
                      alt="Side Banner" 
